...
library(gridExtra)
#FULL BELLY FARM
SWDPlotFBF <- ggplot(SWD_dataFBF, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "FBF N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotFBF <- ggplot(SWD_dataFBF, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "FBF T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
grid.arrange(SWDPlotFBF, T2MPlotFBF, nrow = 2)

#ABF
SWDPlotABF <- ggplot(SWD_dataABF, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "ABF N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotABF <- ggplot(SWD_dataFBF, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "ABF T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
grid.arrange(SWDPlotABF, T2MPlotABF, nrow = 2)

#CM
SWDPlotCM <- ggplot(SWD_dataCM, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "CM N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotCM <- ggplot(SWD_dataCM, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "CM T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
grid.arrange(SWDPlotCM, T2MPlotCM, nrow = 2)

#LBA
SWDPlotLBA <- ggplot(SWD_dataLBA, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "LBA N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotLBA <- ggplot(SWD_dataLBA, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "LBA T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
grid.arrange(SWDPlotLBA, T2MPlotLBA, nrow = 2)

#AlBe
SWDPlotAlBe <- ggplot(SWD_dataAlBe, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "AlBe N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotAlBe<- ggplot(SWD_dataAlBe, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "AlBe T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
grid.arrange(SWDPlotAlBe, T2MPlotAlBe, nrow = 2)

#FrSa
SWDPlotFrSa <- ggplot(SWD_dataFrSa, aes(x=YYYYMMDD, y=N_swd)) +
  geom_line(color = "orange") +
  labs(title = "FrSa N_swd Over Time", x = "Time", y = "Population Count") +
  theme_minimal()
T2MPlotFrSa <- ggplot(SWD_dataFrSa, aes(x=YYYYMMDD, y=T2M)) +
  geom_line(color = "lightblue") +
  labs(title = "FrSa T2M Over Time", x = "Time", y = "Temperature") +
  theme_minimal()
# Stack plots vertically using patchwork
