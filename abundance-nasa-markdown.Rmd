...
cor(AbundanceTempABF$N_swd, lag(AbundanceTempABF$T2M, 10), use = "complete.obs")
cor(AbundanceTempFBF$N_swd, lag(AbundanceTempFBF$T2M, 10), use = "complete.obs")
cor(AbundanceTempLBA$N_swd, lag(AbundanceTempLBA$T2M, 10), use = "complete.obs")
cor(AbundanceTempCM$N_swd, lag(AbundanceTempCM$T2M, 10), use = "complete.obs")
cor(AbundanceTempFrSa$N_swd, lag(AbundanceTempFrSa$T2M, 10), use = "complete.obs")
cor(AbundanceTempAlBe$N_swd, lag(AbundanceTempAlBe$T2M, 10), use = "complete.obs")
```
