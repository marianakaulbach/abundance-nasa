...
**(8)** Create subsets of SWD data from the SWD count sheet for each state.
...
```
The R-squared values were close to zero for all of the sampling groups, indicating a low linear fit. The p-values were insignificant for all groups except Kentucky.
...
```
The R-squared values were close to zero for all of the sampling groups, indicating a low linear fit. The p-values were insignificant as well. This indicates a lack of relationship between humidity and SWD abundance.
...
```
The R-squared values were close to zero for all of the sampling groups, indicating a low linear fit. The p-values signficant for all sampling groups except for Vermont. It is notable though to consider that Vermont had the least variable temperature data over the short sampling period.
